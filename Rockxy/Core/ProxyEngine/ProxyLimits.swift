...
enum ProxyLimits {
    ...
    static let maxRequestBodySize = 100 * 1024 * 1024

    /// Maximum single WebSocket frame payload (10 MB).
    static let maxWebSocketFrameSize = 10 * 1024 * 1024

    /// Maximum total WebSocket payload per connection (100 MB).
    static let maxWebSocketConnectionSize = 100 * 1024 * 1024

    /// Maximum URI length accepted from clients (8 KB).
    static let maxURILength = 8192
}
