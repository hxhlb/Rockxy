...
<Warning>
**Status: Planned** — Performance Insights is not yet implemented. This page describes the planned design and intended behavior. The feature is on the [roadmap](https://github.com/LocNguyenHuu/Rockxy/blob/main/README.md#roadmap).
</Warning>
