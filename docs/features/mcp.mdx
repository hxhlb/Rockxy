...
description: "Connect Rockxy to Claude CLI or Claude Desktop through Rockxy's local MCP bridge so AI tools can inspect captured traffic safely."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Sessions and HAR" icon="file-export" href="/features/sessions">
    Decide when to share data through MCP versus export a file artifact.
  </Card>
  <Card title="FAQ" icon="circle-question" href="/troubleshooting/faq">
    Find the quick answer if the bridge is configured but still unavailable.
  </Card>
</CardGroup>
