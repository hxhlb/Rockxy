...
2. Drag **Rockxy Community.app** into the **Applications** folder.
3. Launch Rockxy Community from Applications or Spotlight.
...
2. Delete `Rockxy Community.app` from the Applications folder.
...
Right-click Rockxy Community.app and select **Open**, or go to **System Settings > Privacy & Security** and click **Open Anyway**.
